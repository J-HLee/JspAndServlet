...
public class BoardDAO {
	...
	//검색한 내용 개수 반환(what:검색조건, content:검색내용)
	public int getArticleWhatCount(String what, String content) {
	...
	public List<BoardVO> getArticlesWhatList(String what, String content, int start, int end) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
